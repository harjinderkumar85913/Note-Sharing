 ...
 export default function ManageSubject(){
     ...
     const updateStatus = (id,status) =>{
             ...
             console.log(data)
             apiServices.updatesubjectStatus(data,{ headers: { authorization: sessionStorage.getItem("token") } })
             .then((res) =>{
     ...
     return(
        ...
        <div class="container ">
            <h1 class="display-1 text-dark animated slideInDown">Manage Subjects</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb text-uppercase mb-0">
                    <li class="breadcrumb-item"><a class="text-dark" href="#">Dashboard</a></li>
                    <li class="breadcrumb-item text-primary active" aria-current="page">Manage Subjects</li>
                </ol>
            </nav>
        </div>
    </div>
     ...
     <div className="container">
       ...
       <div className="row">
         <div className="col-12">
           <h1 className="contact-title text-center">Manage Subjects</h1>
         </div>
         <div className="col-lg-2 offset-lg-10">
             <Link to={"/admin/addsubject"}>
             <button className="btn btn-primary rounded-0">Add Subjects</button>
             </Link>
   ...
   <tbody>
  {
     subjectData?.map((el,index) =>(
         <>
         <tr>
          <td>{index+1}</td>  
          <td>{el.subjectName}</td> 
          <td>{el.courseId?.courseName}</td> 
          <td><img src={BASE_IMAGE_URL + el.subjectImage} height={"200px"}/></td>
          ...
          <td><Link to={"/admin/updatesubject/"+el._id}>
