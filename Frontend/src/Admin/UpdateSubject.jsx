...
export default function UpdateSubject(){
    ...
    useEffect(() =>{
        ...
        .then((res) =>{
            ...
            setPrevImage(res.data.data.subjectImage)
...
useEffect(() =>{
    ...
    const updateData = (e) => {
     ...
     data.append("subjectName",subjectName)
      ...
      setLoader(true)
      setDisplay("none")
      apiServices.updatesubjectData(data)
      .then((res) =>{
    ...
    return(
        ...
        <div class="container py-5">
            <h1 class="display-1 text-dark animated slideInDown">Update Subject</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb text-uppercase mb-0">
                    <li class="breadcrumb-item"><a class="text-dark" href="#">Dashboard</a></li>
                    <li class="breadcrumb-item text-primary active" aria-current="page">Update Subject</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div className="container">
      <div className="row">
        <div className="col-2 offset-lg-8">
          ...
          <button className="btn btn-primary rounded-0">View Subject</button>
          </Link>
        
        </div>
        <div className="col-lg-8 mx-auto p-5 mt-4 mb-5" style={{border:"4px solid black",boxShadow:"8px 8px 8px skyblue"}}>
        <h2 className="contact-title mt-3 text-center">Update Subject</h2>
          <form
          ...
          >
            <div className="row">
              ...
              <div className="col-sm-12 mt-3">
                ...
                <img src={BASE_IMAGE_URL + prevImage} alt="" height={"200px"}/>
