    ...
    return (
        <>
            <>
                        ...
                        <div className="row">
                            <div className="col-12 col-sm-12 col-lg-6 mb-4 order-0 order-sm-0">
                                ...
                                <p className="text-light my-4">
                                    ...
                                    <span className="text-light">1500 Treat Ave, Suite 200 &nbsp;</span>
                            ...
                            <div className="col-6 col-sm-4 col-lg-2 mb-3 order-3 order-sm-2 p-5">
                                <h5 className="lh-lg fw-bold text-light mb-4 font-sans-serif">
                                    {" "}
                                    More
                                </h5>
                ...
                {/* <section> close ============================*/}
                {/* ============================================*/}
                <section className="py-0" style={{ marginTop: "-5.6rem" }}>
